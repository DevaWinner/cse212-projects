...
public class PriorityQueueTests
{
    ...
    [TestMethod]
    // Scenario: Enqueue items in ascending priority order and ensure Dequeue removes them in descending order.
    // Expected Result: Dequeue should return items from highest to lowest priority.
    // Defect(s) Found: Dequeue returned "Item2" instead of "Item3", so items aren't being dequeued in the correct descending priority order.
    public void TestPriorityQueue_AscendingPriorityEnqueue()
    {
        var priorityQueue = new PriorityQueue();
    ...
    [TestMethod]
    // Scenario: Enqueue multiple items with mixed priorities and ensure Dequeue removes correctly.
    // Expected Result: Dequeue should return "Item1" first, then "Item3", then "Item2".
    // Defect(s) Found: Dequeue returned "Item3" before "Item1", which is incorrect based on their priorities.
    public void TestPriorityQueue_MixedPriorities()
    {
        ...
        var firstDequeue = priorityQueue.Dequeue();
        Assert.AreEqual("Item1", firstDequeue, "The first dequeued item should be 'Item1'.");

        var secondDequeue = priorityQueue.Dequeue();
        Assert.AreEqual("Item3", secondDequeue, "The second dequeued item should be 'Item3'.");

        var thirdDequeue = priorityQueue.Dequeue();
        Assert.AreEqual("Item4", thirdDequeue, "The third dequeued item should be 'Item4'.");

        var fourthDequeue = priorityQueue.Dequeue();
        Assert.AreEqual("Item2", fourthDequeue, "The fourth dequeued item should be 'Item2'.");
    }
